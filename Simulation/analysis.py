...
fig, ax = plt.subplots()
#ax.set_title(r"Standard Deviation of $\sin(2 \beta)$ vs Tagging Power $\epsilon_{\text{eff}}$")
ax.set_xlabel(r"Tagging Power $\epsilon_{\text{eff}}$")
ax.set_ylabel(r"Standard Deviation $\sigma(\sin(2 \beta))$")
...
ax.plot(tagging_power_array_cfg, k*tagging_power_array_cfg**(-0.5), color="black", label=r"Expectation $\sigma(S_{f})=A\varepsilon_{\text{eff}}^{-1/2}$")
