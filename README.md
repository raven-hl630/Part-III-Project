...
In this decay channel, the CP violation parameters are $C_{f} = 0$ and $S_{f} = \sin(2\beta)$ to leading order. The CP asymmetry is simply $A_{CP} \approx S_{f} sin(x \Gamma t)$.
